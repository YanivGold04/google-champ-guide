          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Learn Google Sheets fundamentals</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="aspect-video bg-muted rounded-lg flex items-center justify-center">
                  <p className="text-muted-foreground">Video: Creating Spreadsheets and Basic Formulas</p>
                </div>
                <div className="aspect-video bg-muted rounded-lg flex items-center justify-center">
                  <p className="text-muted-foreground">Video: Data Validation and Conditional Formatting</p>
                </div>
                <div className="aspect-video bg-muted rounded-lg flex items-center justify-center">
                  <p className="text-muted-foreground">Video: Charts, Pivot Tables, and the Explore Feature</p>
                </div>
              </CardContent>
            </Card>
